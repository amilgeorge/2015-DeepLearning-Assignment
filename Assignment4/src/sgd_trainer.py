...
class sgd_trainer(object):
    ...
    def __init__(self,batch_size=20,learning_rate=0.01, sparsity_lambda=0.01, n_epochs=20):
        '''
        Constructor
        '''
    ...
    def trainAutoEncoder(self,ae):    
        ...
        cross_entropy_cost = ae.get_cross_enropy_cost()
        sparsity_cost= ae.get_KL_divergence_cost()
        
        cost = cross_entropy_cost + self.sparsity_lambda * sparsity_cost
